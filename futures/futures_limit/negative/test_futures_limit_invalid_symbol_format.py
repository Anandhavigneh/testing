"""
================================================================================
        FUTURES LIMIT E2E TEST SUITE - INVALID SYMBOL FORMAT
================================================================================
...
│ NEGATIVE TEST                                                               │
├─────────────────────────────────────────────────────────────────────────────┤
│ • test_futures_limit_invalid_symbol_format()                                                   │
...
Example Execution:
  pytest futures_limit/negative/test_futures_limit_invalid_symbol_format.py -v
  pytest futures_limit/negative/test_futures_limit_invalid_symbol_format.py --alluredir=allure-results
...
@allure.story("Invalid symbol format")
@pytest.mark.serial
def test_futures_limit_invalid_symbol_format(setup_data):
    client = setup_data["client"]
    with allure.step("Send order with invalid symbol (BTCUSDT_INVALID)"):
        resp = client.create_order(
            ctid=Config.DEFAULT_CTID, symbol="BTCUSDT_INVALID", 
            qty=setup_data["valid_qty"], price=setup_data["valid_price"], 
