"""
================================================================================
        FUTURES LIMIT E2E TEST SUITE - ZERO PRICE
================================================================================
...
Example Execution:
  pytest futures_limit/negative/test_futures_limit_zero_price.py -v
  pytest futures_limit/negative/test_futures_limit_zero_price.py --alluredir=allure-results
...
@allure.story("Zero price")
@pytest.mark.serial
def test_futures_limit_zero_price(setup_data):
    client = setup_data["client"]
    with allure.step("Send order with price = 0"):
        resp = client.create_order(
            ctid=Config.DEFAULT_CTID, symbol=setup_data["symbol"], 
            qty=setup_data["valid_qty"], price="0", 
            amount="0", order_type="1", order_side="0"
        )
