...
│   → Fetch config & ticker → Determine price → Place limit order → Verify    │
└─────────────────────────────────────────────────────────────────────────────┘
...
Example Execution:
  pytest futures_limit/test_futures_limit.py -v
  pytest futures_limit/test_futures_limit.py --alluredir=allure-results
